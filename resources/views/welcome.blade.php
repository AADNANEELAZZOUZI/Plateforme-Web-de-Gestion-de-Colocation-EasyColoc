...
<body class="bg-darkBg text-slate-200 antialiased">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <a href="/register"
                            class="w-full sm:w-auto bg-primary-600 text-white px-8 py-2.5 rounded-xl font-bold text-lg shadow-lg hover:bg-primary-700 hover:shadow-primary-500/20 transition-all text-center">
                            S'inscrire
                        </a>
                    </div>
                </div>
    ...
    <section class="relative pt-20 pb-32 overflow-hidden">
        <div class="absolute top-0 left-1/2 w-full -translate-x-1/2 h-full z-0 pointer-events-none">
            <div
                class="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-primary-900/20 rounded-full blur-3xl opacity-50">
            </div>
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 text-center">
            ...
            <p class="text-xl text-slate-400 max-w-2xl mx-auto mb-10">
                Suivez les dépenses communes, calculez automatiquement les dettes et comprenez enfin « qui doit quoi à
                qui ».
            </p>
            <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
                <button onclick="openModal('register')"
                    class="w-full sm:w-auto bg-primary-600 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-primary-700 hover:shadow-primary-500/20 transition-all">
                    Créer une colocation
                </button>
                <button onclick="document.getElementById('demo').scrollIntoView({behavior: 'smooth'})"
                    class="w-full sm:w-auto bg-slate-800 text-slate-200 border border-slate-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-slate-700 transition-all">
    ...
    <section id="demo" class="bg-slate-950 py-20 border-t border-slate-800">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-slate-500 mt-2">L'interface intuitive conçue pour simplifier la vie des propriétaires et
                    colocataires.</p>
            </div>

            <div
                class="bg-darkCard rounded-2xl shadow-2xl border border-slate-700 overflow-hidden flex flex-col md:flex-row min-h-[600px] fade-in">

                <aside
                    class="w-full md:w-64 bg-slate-900 text-slate-300 flex-shrink-0 flex flex-col justify-between hidden md:flex border-r border-slate-700">
                    <div class="p-6">
                        ...
                        <nav class="space-y-2">
                            <a href="#"
                                class="flex items-center gap-3 px-4 py-3 bg-primary-600/10 text-primary-400 rounded-lg font-medium">
                                📊 Tableau de bord
                            </a>
                            <a href="#"
                                class="flex items-center gap-3 px-4 py-3 hover:bg-slate-800 rounded-lg transition">
                                💸 Dépenses
                            </a>
                            <a href="#"
                                class="flex items-center gap-3 px-4 py-3 hover:bg-slate-800 rounded-lg transition">
                ...
                <main class="flex-1 bg-slate-800/50 overflow-y-auto p-6 md:p-8 custom-scrollbar">
                    ...
                    <div class="bg-slate-800 rounded-xl border border-slate-700 p-6">
                        ...
                        <div
                            class="flex flex-col sm:flex-row justify-between items-center py-4 border-b border-slate-700 gap-4">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-8 h-8 rounded-full bg-red-900/30 text-red-400 flex items-center justify-center font-bold text-xs">
                                    SB</div>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <button
                                    class="text-xs bg-slate-700 border border-slate-600 px-3 py-1.5 rounded hover:bg-slate-600 text-slate-200">Marquer
                                    payé</button>
                            </div>
                        </div>
                    </div>
    ...
    <section id="features" class="py-20 bg-darkBg">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-slate-500 mt-4 max-w-2xl mx-auto">Tout ce dont vous avez besoin pour une vie en
                    communauté sereine.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div
                    class="p-6 rounded-2xl border border-slate-800 bg-slate-900/50 hover:border-primary-500/50 transition group">
                    <div
                        class="w-12 h-12 bg-primary-900/30 text-primary-400 rounded-xl flex items-center justify-center mb-4 group-hover:bg-primary-600 group-hover:text-white transition">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">Plus de calculs fastidieux. Notre algorithme
                        s'occupe de tout.</p>
                </div>
            </div>
        </div>
    ...
    <div id="modal-login" class="fixed inset-0 z-[100] hidden">
        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div
                class="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl w-full max-w-md p-8 fade-in relative z-10">
                ...
                <form onsubmit="event.preventDefault(); closeModal('login');">
                    <div class="mb-4">
                        ...
                        <input type="email"
                            class="w-full bg-slate-800 px-4 py-2 rounded-lg border border-slate-700 text-white focus:ring-2 focus:ring-primary-500 outline-none transition"
                    ...
                    <button type="submit"
                        class="w-full bg-primary-600 hover:bg-primary-700 text-white font-bold py-2.5 rounded-lg transition shadow-md">Se
                        connecter</button>
                </form>
            </div>
        </div>
        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div
                ...
                <form onsubmit="event.preventDefault(); closeModal('register');">
                    ...
                    <button type="submit"
                        class="w-full bg-primary-600 hover:bg-primary-700 text-white font-bold py-2.5 rounded-lg transition">S'inscrire</button>
                </form>
            </div>
        </div>
    </div>
